...
public class trong_DataHelper extends SQLiteOpenHelper {
    ...
    public trong_DataHelper(Context context) {
    ...
    private void insertInitialData(SQLiteDatabase db) {
        ...
        contentValues.put(COLUMN_IMAGE_NAME, "trong_image1");
